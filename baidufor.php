...
<body>	
	<?php for( $i = 0;$i < $length; $i++){?>
		...
		<dl>
			<dt>				
				<a href="#" class="bt"><?php echo $test["title"]; ?></a> 				 
			</dt>
			<dd class="dd">
				 <p><?php echo $test["datetime"]; ?></p> 
                 <div class="zw"><?php echo $test["desc"]; ?></div> 
				 <a class="more" href="#"><?php echo $test["other"]; ?></a> 
				 <a href="#" class="bk"><?php echo $test["kuaizhao"]; ?></a> 
			</dd>
		</dl>	
		<?php }	?>	
